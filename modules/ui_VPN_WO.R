                 ...
                 sidebarPanel(width=4,
                              ...
                              column(12,
                                     ...
                                     conditionalPanel(condition = "input.v_dist_brent_vpn_wo == true",
                                                      sliderInput(inputId ="id_brent_VPN_WO",label = strong(""), 40,100,50,step=10),
                                                      HTML("")
                              ...
                              column(12,
                                     ...
                                     div(title="", # tooltip
                                         awesomeCheckbox(inputId = "v_dist_PD_vpn_wo", label = "PD", value = FALSE,status="success")),
                                     ...
                                     conditionalPanel(condition = "input.v_dist_PD_vpn_wo == true",
                                                      sliderInput(inputId ="id_PD2_vpn_wo",label = strong(""), 0.0,0.3,0.1,step=0.1),
                                                      HTML("")
                              ...
                              column(12,
                                     ...
                                     tags$script("$(\"input:radio[name='id_tipo_costovpn_wo'][value='pesimista']\").parent().css('background-color', '#FF5F00');"),
                                     tags$script("$(\"input:radio[name='id_tipo_costovpn_wo'][value='probable']\").parent().css('background-color', '#808080');"),
