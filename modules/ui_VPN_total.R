                                  ...
                                  column(12,
                                         ...
                                         div(title = "", 
                                             ...
                                             radioGroupButtons("id_tipo_costo_total", 
                                                               label = HTML("<strong>Paso 3.</strong> - Seleccione el tipo de Costo de interes"), 
                                         ...
                                         tags$script("$(\"input:radio[name = 'id_tipo_costo_total'][value = 'pesimista']\").parent().css('background-color', '#808080');"),
                                         tags$script("$(\"input:radio[name = 'id_tipo_costo_total'][value = 'probable']\").parent().css('background-color', '#FF5F00');"),
                                         tags$script("$(\"input:radio[name = 'id_tipo_costo_total'][value = 'optimista']\").parent().css('background-color', '#808080');"),
