tab_perfil <- tabItem(tabName = "tab_perfil",
                      sidebarPanel(width = 4,
                                  column(12,
                                          ...
                                          tags$script("$(\"input:radio[name='id_perf_prod'][value = 'Oil']\").parent().css('background-color', '#F7DB17');"),
                                          tags$script("$(\"input:radio[name='id_perf_prod'][value = 'Water']\").parent().css('background-color', '#CCD32A');"),
                                          tags$script("$(\"input:radio[name='id_perf_prod'][value = 'gas']\").parent().css('background-color', '#004236');"),

                                        ),

                                   div(title="",
                                       awesomeRadio("id_activo_perfil_", label = shiny::HTML("Paso 2. Selecciones el tipo de analisis:<br/><br/>"), #br required to try and keep alignment across columns
                                   ...
                                   div(title="",
                                       awesomeRadio("id_tipo_perfil", label =shiny::HTML("Paso 3. Selecciones el tipo de analisis:<br/><br/>"), #br required to try and keep alignment across columns
                                   ...
                                   div(title="",
                                       awesomeRadio("id_clasificacion_perf", label =shiny::HTML("Paso 7. Selecciones la clasificaci&oacuten:"),
                                                    choices = list("General"= "General",
                                                                   "Ampliaci&oacuten Minima" = "Ampliacion Minima",
