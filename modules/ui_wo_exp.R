...
VPN_tab_basic_vpn <- tabItem(tabName = "tab_basic_vpn", "VPN",
                 fluidRow(
                                ...
                                column(12,
                                       ...
                                       div(title="", # tooltip
                                           ...
                                           prettyRadioButtons("id_tipo_reserva",
                                                              inputId = "Id039",
                                                              label= HTML("<strong>Paso 2.</strong>- Seleccione el tipo de reserva"),
                                                              choices = c('PDP',
                                                                          'PRBP',
                                                                          'PSP'),
                                                              icon = icon("check"), 
...
VPN_tab_basic_wo_vpn<- tabItem(tabName = "tab_basic_wo_vpn", "VPN ",
                   fluidRow(
                     sidebarPanel(width=4,
...
VPN_Basic_WO_NW <- tabItem(tabName = "tab_basic_wo_nw_profile", "VPN ",
                       fluidRow(
                         sidebarPanel(width=4,
                                      ...
                                      column(12,
                                             ...
                                             div(title="", # tooltip
                                                 style = "margin-top: 10px; margin-bottom: 20px;", 
                                                 radioGroupButtons("id_grafi_pp2", 
                                                                   label= HTML("<strong>Paso 3.</strong>- Seleccione el tipo a evaluar."), 
                                                                   choices = c("Sin Socio"='sin_Socio',
                                                                               "Con socio"='con_socio'),
                                                                   checkIcon = list(yes = icon("check")),
                                                                   select='con_socio' ,
                                      ...
                                      column(12,
                                             ...
                                             div(title="", # tooltip
                                                 style = "margin-top: 10px; margin-bottom: 20px;", 
                                                 radioGroupButtons("id_tipo_costo", 
                                                                   label= HTML("<strong>Paso 4.</strong>- Seleccione el tipo de Costo de interes"), 
                                                                   choices = c("Pesimista"='pesimista',
                                                                               "Probable"='probable',
                                                                               "Optimista"='optimista'),
                                                                   checkIcon = list(yes = icon("check")),
